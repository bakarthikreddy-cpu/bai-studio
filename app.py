...
with st.sidebar:
    ...
    api_key = st.text_input("", type="password", placeholder="Enter your Groq API key...", key="api_key_input", label_visibility="collapsed")
    if not api_key:
        st.warning("⚠️ Add your free Groq API key to begin. Get one at console.groq.com")
...
with tab2:
    ...
    st.markdown("Upload any business document and BAi will perform a full BA analysis.")
    
    uploaded_file = st.file_uploader(
        "Upload Document",
        type=["pdf", "docx", "doc", "txt"],
        help="Supported: PDF, Word (.docx), Text files"
    )
...
with tab3:
    ...
    context_input = st.text_area(
        ...
        placeholder="e.g. An e-commerce platform for a Canadian retailer needing a loyalty points system. Users should earn points on purchases, redeem for discounts, and view history in their profile...",
        height=150
    )
...
Produce a complete, ready-to-use {artifact_type} that a senior BA would be proud to submit. Include all standard sections, proper formatting, and real examples based on the description provided."""
